-- ============================================================================
-- cohort_hf_mimic_identify.sql — MIMIC-IV STRICT type-2 diabetes identification cohort, defined
...
hf_adm AS (
  ...
  -- STRICT type-2 diabetes: ICD-10 E11 only; ICD-9 250.x0/250.x2 (5th digit 0/2 = type 2)
  WHERE (icd_version=10 AND icd_code LIKE 'E11%')
     OR (icd_version=9  AND (icd_code LIKE '250_0' OR icd_code LIKE '250_2'))
),
cohort AS (
