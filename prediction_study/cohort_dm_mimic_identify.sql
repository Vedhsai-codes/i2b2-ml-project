-- ============================================================================
-- cohort_hf_mimic_identify.sql — MIMIC-IV diabetes identification cohort, defined
...
hf_adm AS (
  ...
  WHERE (icd_version=10 AND icd_code LIKE 'E08%' OR icd_code LIKE 'E09%' OR icd_code LIKE 'E10%' OR icd_code LIKE 'E11%' OR icd_code LIKE 'E13%') OR (icd_version=9 AND icd_code LIKE '250%')
),
cohort AS (
