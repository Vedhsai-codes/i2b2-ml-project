-- ============================================================================
-- cohort_hf_mimic_identify.sql — MIMIC-IV CKD identification cohort, defined
...
hf_adm AS (
  ...
  WHERE (icd_version=10 AND icd_code LIKE 'N18%') OR (icd_version=9 AND icd_code LIKE '585%')
),
cohort AS (
